...
# for the N(mu,sigma), i.e. normal dist with mean=mu and std dev=sigma, look up area to the right of X=z (upper tail)
mu <- 0
sigma <- 1
z <- 2
isLowerTail <- FALSE
pnorm(z,mean=mu,sd=sigma,lower.tail=isLowerTail)
```
...
# for the N(mu,sigma), i.e. normal dist with mean=mu and std dev=sigma
